   ...
   <div class="navbar-header">
    <p class="navbar-brand" >${student.name} ${student.surname}</p>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
        <a class="glyphicon glyphicon-user" href="Student/update?id=${student.id}">Personal Information</a>
        </li>
        <li>
        <a href="Student/courses?id=${student.id}">Courses</a>
        </li>
        <li>
        <a class=" glyphicon glyphicon-log-out" href="Student/logout">Logout</a>
        </li>
       </ul>
      </div>    
  </nav>
