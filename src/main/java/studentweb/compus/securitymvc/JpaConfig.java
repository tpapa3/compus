...
@Configuration
@EnableJpaRepositories(basePackages="studentweb.compus.repository", transactionManagerRef = "transactionManager")
@PropertySource(value = { "classpath:application.properties" })
@EnableTransactionManagement
public class JpaConfig {
	private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "studentweb.compus.entity" };
